        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 pb-12">
            <div>
                <a href="{{ url('/') }}" class="flex items-center gap-2.5 mb-4">
                    ...
                    <span class="text-lg font-display font-bold text-white">{{ config('app.name') }}</span>
                </a>
                <p class="text-sm text-gray-400 leading-relaxed mb-6">
                    Bangladesh's first all-in-one digital platform — premium courses, ready-made software, and expert support.
                </p>
                <div class="flex items-center gap-3">
                    <a href="#" class="w-9 h-9 rounded-lg bg-gray-800 hover:bg-accent flex items-center justify-center transition">
