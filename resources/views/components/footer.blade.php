<footer class="w-full py-section-gap px-margin-mobile md:px-margin-desktop bg-surface border-t border-surface-container">
    <div class="max-w-container-max mx-auto flex flex-col lg:flex-row justify-between items-start gap-12">
        <div class="max-w-sm">
            <a href="{{ url('/') }}"
                class="font-headline-md text-headline-md font-bold text-primary mb-4 block">আপনার Business</a>
            <p class="font-body-md text-body-md text-secondary leading-relaxed mb-8">
                Empowering entrepreneurs to scale through elite technology and strategic consulting.
            </p>
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-x-12 gap-y-10">
                ...
                <div class="flex flex-col gap-4">
                    <span class="label-sm text-primary font-bold">Products</span>
                    <a href="{{ url('/#products') }}"
                        class="font-label-sm text-secondary hover:text-primary hover:underline transition">Inventory Pro</a>
                    <a href="{{ url('/#products') }}"
                        class="font-label-sm text-secondary hover:text-primary hover:underline transition">RetailFlow</a>
                    <a href="{{ url('/#products') }}"
                        class="font-label-sm text-secondary hover:text-primary hover:underline transition">EduScale</a>
                </div>
            <div class="flex flex-col gap-4">
    ...
    <div class="max-w-container-max mx-auto mt-12 pt-8 border-t border-surface-container flex flex-col sm:flex-row items-center justify-between gap-3">
        <p class="font-label-sm text-secondary">&copy; {{ date('Y') }} আপনার Business. All rights reserved.</p>
